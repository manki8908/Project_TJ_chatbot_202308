SUBROUTINE READ_BINARY(infile, NV, NS, NH, NF, buf, ndate1)
  ...
  INTEGER, DIMENSION(NH,4), INTENT(OUT) :: ndate1
...
!  END IF
  ...
  PRINT *, "========== Start Read DFS bianary plus ndate", TRIM(infile)
