def test_data_load(data_dir, data_per, nwp_element, input_size, output_size, num_his, num_fct, run_stn_id): 
    ...
    #dropna_nwp, dropna_obs = Remove_nan_batch(re_nwp_stn, re_obs_stn, 
    #                                 input_size, num_fct, output_size)


    print ('---------- Skip drop nan for test')
