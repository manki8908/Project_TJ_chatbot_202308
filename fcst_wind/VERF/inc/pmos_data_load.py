#def pmos_data_load(data_dir, data_per, element, num_stn, num_his, num_fct, test_x, test_y): 
def pmos_data_load(data_dir, data_per, mos_name, element, stn_idx, num_stn, num_his, num_fct): 
