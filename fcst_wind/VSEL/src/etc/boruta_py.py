...
class BorutaPy(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, estimator, n_estimators=100, perc=100, alpha=0.05,
                 two_step=True, max_iter=300, random_state=None, verbose=0,
    ...
    def _fit(self, X, y):
        ...
        # Scores by Min-Jong, 2021.05.24
        self.shadow_history = sha_max_history
        self.importance = imp_history
